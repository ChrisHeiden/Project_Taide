...
// SOIL to use differnt Typs of Images
...
int main()
{
	...
	GLFWwindow *window = glfwCreateWindow(WIDTH, HEIGHT, "PROJECT: Taide", nullptr, nullptr);
	...
	// Load textures
	GLuint cubeTexture = Texture::LoadTexture("resources/images/House/container2.png");
