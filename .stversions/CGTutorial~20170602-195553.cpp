...
float neigungXUp = 0.0;
float neigungXDown = 0.0;
...
int main(void)
{
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		if (neigungXUp <= 45)
		{
			ViewTemp = glm::rotate(ViewTemp, neigungXUp, glm::vec3(1, 0, 0));
			ViewTemp = glm::rotate(ViewTemp, neigungXDown, glm::vec3(1, 0, 0));
		}
