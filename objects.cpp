...
static void createHouse()
{
	...
	glGenVertexArrays(1, &VertexArrayIDHouse);
	glBindVertexArray(VertexArrayIDHouse);
	...
	static const GLfloat g_vertex_buffer_data[] = {
		...
		// Front left //
		-15.0f,-1.0f,0.0f, -15.0f,-5.0f, 0.0f, -15.0f,-1.0f,-0.5f,
		-15.0f,-5.0f,0.0f, -15.0f,-5.0f,-0.5f, -15.0f,-1.0f,-0.5f,

		-1.0f, -1.0f, 0.0f, -1.0f,-1.0f,-0.5f,  -1.0f,-5.0f,0.0f,
		-1.0f,-1.0f,-0.5f,  -1.0f,-5.0f,-0.5f, -1.0f,-5.0f,0.0f,
	
		-15.0f,-1.0f,0.0f, -15.0f,-1.0f,-0.5f, -1.0f,-1.0f,0.0f,
		-15.0f,-1.0f,-0.5f, -1.0f,-1.0f, 0.0f, -1.0f,-1.0f,-0.5f,
		
		-15.0f,-5.0f,-0.5f, -1.0f,-5.0f,0.0f, -15.0f,-5.0f,0.0f,
		-15.0f,-5.0f,-0.5f, -1.0f,-5.0f, -0.5f, -1.0f,-5.0f,0.0f,

		-15.0f,-5.0f,0.0f, -15.0f,-1.0f,0.0f, -1.0f,-5.0f,0.0f,
		-1.0f,-5.0f,0.0f, -1.0f,-1.0f,0.0f,  -15.0f,-1.0f,0.0f,

		-15.0f,-5.0f,-0.5f, -15.0f,-1.0f,-0.5f, -1.0f,-5.0f,-0.5f,
		-1.0f,-5.0f,-0.5f, -1.0f,-1.0f,-0.5f,  -15.0f,-1.0f,-0.5f,

		// Left side //
		-15.0f,-1.0f,-0.5f, -14.75f,-1.0f,-0.5f, -15.0f,-1.0f,-15.0f,
		-14.75f,-1.0f,-0.5f, -15.0f,-1.0f,-15.0f, -14.75f,-1.0f,-15.0f,

		-15.0f,-5.0f, -0.5f, -14.75f,-5.0f,-0.5f,  -15.0f,-5.0f,-15.0f,
		-15.0f,-5.0f,-15.0f,  -15.75f,-5.0f,-15.0f, -14.75f,-5.0f,-0.5f,

		-15.0f,-1.0f,-0.5f, -14.75f,-1.0f,-0.5f, -14.75f,-5.0f,-0.5f,
		-14.75f,-5.0f,-0.5f, -15.0f,-5.0f, -0.5f, -15.0f,-1.0f,-0.5f,

		-15.0f,-1.0f,-15.0f, -14.75f,-1.0f,-15.0f, -15.0f,-5.0f,-15.0f,
		-14.75f,-1.0f,-15.0f, -15.0f,-5.0f,-15.0f, -14.75f,-5.0f,-15.0f,

		-15.0f,-1.0f,-0.5f, -14.75f,-5.0f,-15.0f, -14.75f,-5.0f,-0.5f,
		-15.0f,-1.0f,-0.5f, -14.75f,-5.0f,-15.0f, -14.75f,-1.0f, -15.0f,

		-15.0f,-1.0f,-0.5f, -15.0f,-5.0f,-15.0f, -15.0f,-5.0f,-0.5f,
		-15.0f,-1.0f,-0.5f, -15.0f,-5.0f,-15.0f, -15.0f,-1.0f,-15.0f,

		// Backside  //
		-15.0f,-1.0f,-14.75f, -15.0f,-5.0f, -14.75f, -15.0f,-1.0f,-15.0f,
		-15.0f,-5.0f,-14.75f, -15.0f,-5.0f,-15.0f, -15.0f,-1.0f,-15.0f,

		15.0f, -1.0f,-14.75f, 15.0f,-1.0f,-15.0f,  15.0f,-5.0f,-14.75f,
		15.0f,-1.0f,-15.0f,  15.0f,-5.0f,-15.0f, 15.0f,-5.0f,-14.75f,

		-15.0f,-1.0f,-14.75f, -15.0f,-1.0f,-15.0f, 15.0f,-1.0f,-14.75f,
		-15.0f,-1.0f,-15.0f, 15.0f,-1.0f,-14.75f, 15.0f,-1.0f,-15.0f,

		-15.0f,-5.0f,-15.0f, 15.0f,-5.0f,-14.75f, -15.0f,-5.0f,-14.75f,
		-15.0f,-5.0f,-15.0f, 15.0f,-5.0f,-15.0f, 15.0f,-5.0f,-14.75f,

		-15.0f,-5.0f,-14.75f, -15.0f,-1.0f,-14.75f, 15.0f,-5.0f,-14.75f,
		15.0f,-5.0f,-14.75f, 15.0f,-1.0f,-14.75f,  -15.0f,-1.0f,-14.75f,

		-15.0f,-5.0f,-15.0f, -15.0f,-1.0f,-15.0f, 15.0f,-5.0f,-15.0f,
		15.0f,-5.0f,-15.0f, 15.0f,-1.0f,-15.0f,  -15.0f,-1.0f,-15.0f,
		...
		1.0f,-1.0f,0.0f, 1.0f,-5.0f, 0.0f, 1.0f,-1.0f,-0.5f,
		1.0f,-5.0f,0.0f, 1.0f,-5.0f,-0.5f, 1.0f,-1.0f,-0.5f,

		15.0f, -1.0f, 0.0f, 15.0f,-1.0f,-0.5f, 15.0f,-5.0f,0.0f,
		15.0f,-1.0f,-0.5f, 15.0f,-5.0f,-0.5f, 15.0f,-5.0f,0.0f,

		1.0f,-1.0f,0.0f, 1.0f,-1.0f,-0.5f, 15.0f,-1.0f,0.0f,
		1.0f,-1.0f,-0.5f, 15.0f,-1.0f, 0.0f, 15.0f,-1.0f,-0.5f,

		1.0f,-5.0f,-0.5f, 15.0f,-5.0f,0.0f, 1.0f,-5.0f,0.0f,
		1.0f,-5.0f,-0.5f, 15.0f,-5.0f, -0.5f, 15.0f,-5.0f,0.0f,

		1.0f,-5.0f,0.0f, 1.0f,-1.0f,0.0f, 15.0f,-5.0f,0.0f,
		15.0f,-5.0f,0.0f, 15.0f,-1.0f,0.0f, 1.0f,-1.0f,0.0f,

		1.0f,-5.0f,-0.5f, 1.0f,-1.0f,-0.5f, 15.0f,-5.0f,-0.5f,
		15.0f,-5.0f,-0.5f, 15.0f,-1.0f,-0.5f, 1.0f,-1.0f,-0.5f,
	};
...
void drawHouse2()
{
	...
	// Draw the triangles !
	glBindVertexArray(VertexArrayIDHouse);
	glDrawArrays(GL_TRIANGLES, 0, 60 * 3); // 12*3 indices starting at 0 -> 12 triangles
}

GLuint VertexArrayIDRoof = 0;
...
static void createRoof()
{
	...
	glGenVertexArrays(1, &VertexArrayIDRoof);
	glBindVertexArray(VertexArrayIDRoof);
...
static void createDoor()
{
	...
	glGenVertexArrays(1, &VertexArrayIDDoor);
	glBindVertexArray(VertexArrayIDDoor);

	// Our vertices. Tree consecutive floats give a 3D vertex; Three consecutive vertices give a triangle.
	// A cube has 6 faces with 2 triangles each, so this makes 6*2=12 triangles, and 12*3 vertices
	static const GLfloat g_vertex_buffer_data[] = {
		-1.0f,-1.0f,0.0f, 1.0f,-5.0f,0.0f, 1.0f,-1.0f,0.0f,
		-1.0f,-1.0f,0.0f, 1.0f,-5.0f,0.0f, -1.0f,-5.0f,0.0f,

		-1.0f,-1.0f,-0.5f, 1.0f,-5.0f,-0.5f, 1.0f,-1.0f,-0.5f,
		-1.0f,-1.0f,-0.5f, 1.0f,-5.0f,-0.5f, -1.0f,-5.0f,-0.5f,

		-1.0f,-1.0f,0.0f, -1.0f,-5.0f,-0.5f, -1.0f,-5.0f,0.0f,
		-1.0f,-1.0f,0.0f, -1.0f,-5.0f,-0.5f, -1.0f,-1.0f,-0.5f,

		-1.0f,-1.0f,0.0f, 1.0f,-1.0f,-0.5f, 1.0f,-1.0f,0.0f,
		-1.0f,-1.0f,0.0f, 1.0f,-1.0f,-0.5f, -1.0f,-1.0f,-0.5f,

		1.0f,-1.0f,0.0f, 1.0f,-5.0f,-0.5f, 1.0f,-5.0f,0.0f,
		1.0f,-1.0f,0.0f, 1.0f,-5.0f,-0.5f, 1.0f,-1.0f,-0.5f,

		1.0f,-5.0f,0.0f, -1.0f,-5.0f,-0.5f, 1.0f,-5.0f,-0.5f,
		1.0f,-5.0f,0.0f, -1.0f,-5.0f,-0.5f, -1.0f,-5.0f,0.0f,
